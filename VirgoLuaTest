...
if not isfolder("PotzkieSave") then
makefolder("PotzkieSave")
end
if not isfolder("PotzkieSave/Blox Fruits/") then
makefolder("PotzkieSave/Blox Fruits/")
end
if not isfile("PotzkieSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
writefile("PotzkieSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
else
  local Decode = game:GetService("HttpService"):JSONDecode(readfile("PotzkieSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
writefile("PotzkieSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
end
else
  return warn("Status : Undetected Executor")
end
...
local Tab6 = Win:Tab("Server",14477663692)
...
-------------[Tab4]-------------
local JoinID = Tab6:CraftPage(1)
JoinID:Seperator("Join Job ID")
---------------------------------------------------------------

JoinID:Textbox('Job ID',nil,function(jo)
  _G.Job = jo
end)

JoinID:Button('Join Job ID',function()
